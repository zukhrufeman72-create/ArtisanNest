...
import SellerOrderStatusUpdate from '@/components/seller/SellerOrderStatusUpdate'
...
type Props = { orders: Order[]; totalEarnings: number }
...
function OrderCard({ order }: { order: Order }) {
  ...
  const sellerEarnings = order.items.reduce((s, i) => s + i.price * i.quantity, 0)
    ...
    <div className={`bg-white rounded-2xl border overflow-hidden transition-all duration-300
      ...
      <div className="px-5 py-4 flex items-center gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-2.5 min-w-0 flex-1">
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#7D9B76] to-[#5C7756] flex items-center justify-center shrink-0 text-white text-xs font-bold">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-bold text-[#7D9B76]">{formatPrice(sellerEarnings)}</p>
            <p className="text-[10px] text-[#9E8079]">your earnings</p>
          </div>
        ...
        <div className="border-t border-[#EAE3DC]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#F5EFE6] bg-[#FDFAF7]">
            ...
            <div className="px-5 py-4 space-y-3">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#7D9B76] to-[#5C7756] flex items-center justify-center text-white text-sm font-bold shrink-0">
                  {initials(order.user?.name ?? 'Unknown')}
                </div>
                <div>
          ...
          <div className="px-5 py-4 border-t border-[#F5EFE6]">
            <p className="text-[10px] font-bold text-[#9E8079] uppercase tracking-widest mb-3 flex items-center gap-1.5">
              <Package size={11} /> Your Items in This Order
            </p>
          ...
          <div className="px-5 pb-5 grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-[#F5EFE6]">
            ...
            <div className="bg-[#F9F6F2] rounded-xl p-4 space-y-2 text-sm mt-4">
              ...
              <div className="flex justify-between text-xs pt-1">
                <span className="text-[#9E8079]">Your Earnings</span>
                <span className="font-bold text-[#7D9B76]">{formatPrice(sellerEarnings)}</span>
              </div>
            </div>
...
export default function SellerOrdersView({ orders, totalEarnings }: Props) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-[#9E8079] mt-0.5">Full details of orders containing your products</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <StatCard icon={TrendingUp}   label="Total Earnings" value={formatPrice(totalEarnings)} color="bg-[#7D9B76]/10 text-[#7D9B76]" />
        <StatCard icon={Clock}        label="Pending"        value={pendingCount}            color="bg-amber-50 text-amber-600"  sub="Need action" />
